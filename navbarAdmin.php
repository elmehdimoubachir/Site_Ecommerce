...
<head>
  ...
  #btnnon:hover{
    ...
    <?php
      ...
      $sql="SELECT COUNT(id) AS NUMO FROM `order` WHERE `order`.Stutat=0";
      $num_O = mysqli_query($conn,$sql);
      $NUMO=mysqli_fetch_assoc($num_O);
    ?>
</head>
<body>
<nav>
      <div class="header">
          ...
          <a href="EspaceAdmin.php">Home</a>
          <a href="Boxorder.php" id="orderbtn">Orders <span class="badge"><?php echo $NUMO['NUMO']; ?></span></a>
          <a href="createOffre.php">Create offre</a>
          <a href="EspaceAdmin.php #offre">Offres</a>
          <a href="EspaceAdmin.php #Product">Product</a>
          </div></center>
